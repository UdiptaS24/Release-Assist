...
class ReleaseRecord(ReleaseRequest):
    ...
    status: Literal["PENDING", "APPROVED", "NEEDS_REVIEW", "BLOCKED", "SCHEDULED"] = Field(default="PENDING", description="Current status of the release automatically set by agent: PENDING, APPROVED, NEEDS_REVIEW, BLOCKED")
